  ...
  return (
    <div>
      ...
      <div className="privacyInfoButtonDiv">
        <InfoIcon className="privacyInfoButton" onClick={handleButtonClick} style={{fontSize: 50}}>Toggle Privacy</InfoIcon>
      </div>

      <div>
        {isPrivacyVisible && <div className="privacy">
          ...
          <div>
            ...
            <br></br>
            Topics:<br></br>- What data do we collect?<br></br>- How do we collect
            your data?<br></br>- How will we use your data?<br></br>- How do we
            store your data?<br></br>- Marketing<br></br>- What are your data
            protection rights?<br></br>- What are cookies?<br></br>- How do we use
            cookies?<br></br>- What types of cookies do we use?<br></br>- How to
            manage your cookies<br></br>- Privacy policies of other websites
            <br></br>- Changes to our privacy policy<br></br>- How to contact us
            ...
            Password<br></br>- Username<br></br>- Real name<br></br>- Age<br></br>
            <br></br>
            How do we collect your data?<br></br>
            You directly provide Drawful with all of the data we collect. We
            collect data and process data when you:<br></br>- In order to make an
            account, you are required to provide username email and a password
            <br></br>- Have the choice in settings to add your real name to your
            account<br></br>
            <br></br>
            How will we use your data?<br></br>
            Drawful collects your data so that we can:<br></br>- Identify you when
            you log on<br></br>- Display your drawing and provide credit to your
            account<br></br>- Can keep your streak, badges and profile details
            saved<br></br>- Keep a your friends list and friend requests<br></br>-
            If you forget your password, we will use your email to send an email
            allowing you to reset your account password<br></br>
            Drawful does not share your data with any partner companies.<br></br>
            <br></br>
            How do we store your data?<br></br>
            Drawful securely stores your data at a server in a VM provided by The
            University of Birmingham and we are hashing passwords<br></br>
            using Argon2Id to ensure that passwords cannot be taken.<br></br>
            User data will be encrypted then using AES-256, before being stored in
            the database.<br></br>
            Drawful will keep your email indefinitely until manually deleted by
            the user. <br></br>
            The user can manually delete their account and therefore their email
            tied to the account.<br></br>
            <br></br>
            Marketing<br></br>
            ...
            The right to access - You have the right to request Drawful for copies
            of your personal data. We may charge you a small fee for this service.
            <br></br>
            The right to rectification - You have the right to request that
            Drawful correct any information you believe is inaccurate.<br></br>
            You also have the right to request Drawful to complete information you
            believe is incomplete.<br></br>
            ...
            Drawful restrict the<br></br>
            processing of your personal data, under certain conditions.<br></br>
            The right to object to processing - You have the right to object to
            Drawful processing of your personal data, under certain conditions.
            <br></br>
            ...
            and visitor behaviour information. When you visit our websites, we may
            collect information<br></br>
            ...
            Drawful uses cookies in a range of ways to improve your experience on
            our website, including<br></br>- Keeping you signed in<br></br>- What
            language you chose<br></br>- Any accessibility changes you made
            <br></br>
            <br></br>
            What types of cookies do we use?<br></br>
            There are a number of different types of cookies, however, our website
            uses:<br></br>- Functionality - Drawful uses these cookies so that we
            recognize you on our website<br></br>
            so we can keep you signed in and remember your previously selected
            accessibility / language preferences. Drawful only uses first party
            cookies.<br></br>
            <br></br>
            How to manage cookies<br></br>
            You can set your browser not to accept cookies, and the above website
            tells you how to<br></br>
            remove cookies from your browser. However, in a few cases, some of our
            website features may not function as a result.<br></br>
            <br></br>
            ...
            read their privacy<br></br>
            policy.<br></br>
            <br></br>
            Changes to our privacy policy<br></br>
            Drawful keeps its privacy policy under regular review and places any
            updates on this web<br></br>
            page. This privacy policy was last updated on 13th March 2023<br></br>
            <br></br>
            How to contact us<br></br>
            If you have any questions about Drawful’s privacy policy, the data we
            hold on you, or you<br></br>
            would like to exercise one of your data protection rights, please do
            not hesitate to contact us.<br></br>
            <br></br>
